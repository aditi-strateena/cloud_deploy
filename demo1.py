...
# import sqlalchemy
# import psycopg2  # used by SQLAlchemy driver

# # Your DB configs except host (Cloud SQL connector handles this)
# DB_CONFIG = {
#     'dbname': 'new_db',
#     'user': 'postgres',
...
#         "pg8000",  # driver name supported by the connector (or use 'psycopg2' if you prefer and compatible)
#         user=DB_CONFIG['user'],
#         password=DB_CONFIG['password'],
#         db=DB_CONFIG['dbname'],
#         ip_type=IPTypes.PUBLIC  # Use IPTypes.PRIVATE if your instance uses private IP
#     )
#     return conn

# def get_engine():
#     # SQLAlchemy engine uses the connector’s connection function as creator
...
with tabs[0]:
    ...
    with right_col: 
        ...
        output_file = "data.json"  # Unused in current code
